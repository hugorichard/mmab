...
mu = np.array([0.9, 0.8, 0.8, 0.7])  # Reward of each arm
...
np.save("../data/no_elimination_big_rss", rss)
np.save("../data/no_elimination_big_rss_median", rss_median)
np.save("../data/no_elimination_big_rss_high", rss_high)
np.save("../data/no_elimination_big_rss_low", rss_low)
